...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para intercambiar nuestros marcadores de posición de atributo
    | con algo más fácil de leer como "Dirección de correo electrónico" en lugar de "correo electrónico". Esto simplemente nos ayuda a hacer nuestro mensaje más expresivo.
    |
    */
